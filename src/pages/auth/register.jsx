  ...
  return (
    ...
    <div className="w-[55%] h-[1600px] flex justify-center items-center bg-white">
      <div className="w-[426px] h-auto flex flex-col p-0 justify-center">
        ...
        <p className="font-air font-medium text-[13px] text-[#999999] text-center mt-6">Already have an account? <Link className="text-[#EFC81A]" href='/auth/login'>Log in Here</Link> </p>
      </div>
    </div>
  </div>
  )
